...
- No IDE. I am only allowed vim without plugins. Vim's builtin syntax highlighting and autocomplete disabled as well. (Builtin autocomplete is relatively new but does in fact exist)
